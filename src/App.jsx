...
import OfficeList from "@/OfficeList.jsx"; // ⬅️ import your list
...
function App() {
  ...
  const handleUserLogin = () => {
    const telegramUrl = "https://t.me/propoly1";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className=" flex items-center space-x-4 rtl:space-x-reverse">
              ...
              <div className="text-xl font-bold text-sky-600 mr-2 ml-2">
                propoly
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-8 rtl:space-x-reverse">
              ...
              <a
                href="#contact"
                className="text-foreground hover:text-sky-600 transition-colors font-medium ml-4"
              >
                {t.navContact}
              </a>
              <button
        ...
        >
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-sky-200 text-sky-700 hover:bg-sky-50 text-lg px-8 py-6"
            >
              {t.contactUs}
            </Button>
          </motion.div>
      ...
      {/* 👇 Show OfficeList when "get" is clicked */}
      {showOffices && (
        <section id="get" className="py-20 px-4 bg-sky-50/50">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                  ...
                  <span className="text-sky-100 ml-2 mr-2 uppercase">
                    {" "}
                    ITE Damasucs.
                  </span>
                </div>
